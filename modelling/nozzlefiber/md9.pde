...
TITLE 'md9'     { the problem identification }
...
DEFINITIONS
    ...
    transfer('head_optie1_output\head_Darcy55.2.dat', head)
...
{HEAT INPUT to Cables}
	Heatin=230												{Voltage for every timestep, will be calculated to heat input}
